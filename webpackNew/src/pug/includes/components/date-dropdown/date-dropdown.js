...
// Обработка события с полосой между выбранными днями для -range-from-
// let cells = document.querySelector('.datepicker--cells')

//    setInterval(function() {
//       let start = cells.querySelector('.-range-from-')
//       if (start.nextSibling.classList.contains('.-in-range-') || start.nextSibling.classList.contains('.-range-to-')) {
//          start.classList.toggle('.-for-range-from-style-')
//          console.log(1)
//       }
//    }, 20)